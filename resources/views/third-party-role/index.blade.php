@extends('layouts.app')@section('cxmTitle', 'Third Party Role')
@section('content')
    @push('css')
        @include('third-party-role.style')
    @endpush
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}"><i class="zmdi zmdi-home"></i> {{ config('app.home_name') }}
                                </a></li> <li class="breadcrumb-item"> Third Party Roles</li>
                            <li class="breadcrumb-item active"><a href="{{route('user.third.party.role.index')}}"> Index</a></li>
                        </ul>
                        ...
                        <div class="">
                            <div class="table-responsive">
                                <table id="ThirdPartyRoleTable" class="table table-striped table-hover xjs-basic-example theme-color">
                                    ...
                                    <tbody>
                                    @foreach($third_party_roles as $key => $third_party_role)
                                        <tr>
                                            ...
                                            <td class="align-middle text-nowrap">
                                                <button data-id="{{$third_party_role->id}}" title="Edit" class="btn btn-info btn-sm btn-round editThirdPartyRole" data-toggle="modal" data-target="#editThirdPartyRoleModal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="amount" type="text" name="amount" class="form-control" placeholder="Amount" value="0">
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" id="update_form">
                    <input type="hidden" id="hdn" class="form-control" name="hdn" value="">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="team_key">Select Team Name</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="edit_amount" type="text" name="amount" class="form-control" placeholder="Amount" value="0">
                            </div>
                        </div>
                        <div class="form-group">
...
@endsection
@push('cxmScripts')
    @include('third-party-role.script')
@endpush
