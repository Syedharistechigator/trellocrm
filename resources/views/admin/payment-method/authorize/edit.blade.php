				...
				<div class="row">
					<div class="col-lg-7 col-md-6 col-sm-12">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="{{route('admin.payment.method.authorize.index')}}">Payment Methods Authorize.Net</a></li>
						...
						<div class="card">
							...
							<div class="body">
								<form id="update_form">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group form-float">
												...
												<input type="text" class="form-control" id="name" name="name" value="{{$method->merchant}}" minlength="3" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group form-float">
												<label for="email">Email</label>
												<input id="email" type="email" class="form-control" value="{{$method->email}}" name="email" required>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-float">
												<label for="login_id">Login Id</label>
												<input id="login_id" type="text" class="form-control" value="{{$method->live_login_id}}" name="login_id" required>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-float">
												<label for="transaction_key">Transaction Key</label>
												<input id="transaction_key" type="text" class="form-control" value="{{$method->live_transaction_key}}" name="transaction_key" required>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-float">
									...
									<div class="custom-control custom-switch mb-3">
										<input data-id="{{$method->id}}" type="checkbox" class="custom-control-input toggle-class authorization-mode" id="customSwitchAuthorization{{$method->id}}" {{ $method->authorization ? 'checked' : '' }}>
										<label class="custom-control-label" for="customSwitchAuthorization{{$method->id}}">Authorization</label>
									</div>
									<div class="custom-control custom-switch mb-3">
