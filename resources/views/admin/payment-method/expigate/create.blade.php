                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.payment.method.expigate.index')}}">Payment Method Expigate/Amazon</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Create </strong> Payment Method Expigate/Amazon</h2>
                            </div>
                            <div class="body">
                                <form id="expigate_create_form">
                                    @csrf
                                    @method('POST')
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-float">
                                                ...
                                                <select class="form-control show-tick ms select2" data-placeholder="Select" id="merchant_type" name="merchant_type">
                                                    ...
                                                    <option value="0" selected>Expigate</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-float">
                                                ...
                                                <input id="payment-url" type="text" class="form-control" name="payment_url" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group form-float">
