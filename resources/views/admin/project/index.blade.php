                            ...
                            <table id="projectTable" class="table table-striped table-hover js-basic-example theme-color">
                                ...
                                @foreach($projectsData as $project)
                                    <tr>
                                        ...
                                        @endif
                                        <button data-id="{{$project->id}}" title="Edit" class="btn btn-warning btn-sm btn-round editproject" data-toggle="modal" data-target="#EditProjecteModal"><i class="zmdi zmdi-edit"></i></button>
                                        <a title="Change Status" data-id="{{$project->id}}" data-type="confirm" href="javascript:void(0);" class="btn btn-danger btn-sm btn-round statusChange" data-toggle="modal" data-target="#changeStatusModal"><span class="zmdi zmdi-settings"></span></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
