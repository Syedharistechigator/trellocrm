...
@section('cxmTitle', 'Zoom Configuration')
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Zoom Configuration</li>
                        <li class="breadcrumb-item active"> List</li>
                    </ul>
                    <button class="btn btn-primary btn-icon mobile_menu" type="button"><i class="zmdi zmdi-sort-amount-desc"></i></button>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-12 text-right">
                    <a href="{{ route('admin.zoom.configuration.create') }}" class="btn btn-success btn-icon rounded-circle" type="button"><i class="zmdi zmdi-plus"></i></a>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="table-responsive">
                            <table id="ZoomConfigurationTable" class="table table-striped table-hover theme-color js-exportable" data-sorting="false">
                                <thead>
                                <tr>
                                    <th>Id#</th>
                                    <th>Parent Email</th>
                                ...
                                <tbody>
                                    ...
                                    <tr id="tr-{{$email->id}}">
                                        ...
                                        <td class="align-middle text-center">
                                            <a title="Edit" href="{{route('admin.zoom.configuration.edit',[$email->id])}}" class="btn btn-warning btn-sm btn-round"><i class="zmdi zmdi-edit"></i></a>
