            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}"><i class="zmdi zmdi-home"></i> {{ config('app.name') }}
                                </a></li>
                            <li class="breadcrumb-item"><a href="{{route('admin.zoom.configuration.index')}}">Zoom Configuration</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Update</strong> Zoom Configuration</h2>
                            </div>
                            <div class="body">
                                <form id="zoom_configuration_update_form" method="POST">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-float">
                                                ...
                                                <input type="text" class="form-control" id="client_id" name="client_id" value="{{$email->parent_id != 0 ?$email->parent->client_id : $email->client_id}}" required {{$email->parent_id > 0 ? "": "" }}>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-float">
                                                ...
                                                <input type="text" class="form-control" id="client_secret" name="client_secret" value="{{$email->parent_id != 0 ?$email->parent->client_secret : $email->client_secret}}" required {{$email->parent_id > 0 ? "": "" }}>
...
{{--                                                            <input type="text" class="form-control" id="{{$key}}" name="{{$key}}" value="{{ json_decode($email->access_token, true)['expires_at']  - time()  > 0 ? json_decode($email->access_token, true)['expires_at']  - time() : "Expired"}}">--}}
                                    ...
                                    <input id="update_data" type="submit" value="Submit" class="btn btn-warning btn-round zc-submit">
