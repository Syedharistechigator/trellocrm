        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Trashed Zoom Configuration List</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> TG</a></li>
                        <li class="breadcrumb-item"> Zoom Configurations</li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table id="ZoomConfigurationTrashedTable" class="table table-striped table-hover theme-color js-exportable" data-sorting="false">
                                <thead>
                                    <tr>
                                        <th>Id#</th>
                                        <th>Parent Id</th>
                                    ...
                                    @foreach($emails as $email)
                                        <tr id="tr-{{$email->id}}">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="Force Delete" data-id="{{$email->id}}" href="javascript:void(0);" class="btn btn-danger btn-sm btn-round zc-force-del"><i class="zmdi zmdi-delete"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
