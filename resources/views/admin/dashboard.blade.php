@extends('admin.layouts.app')@section('cxmTitle', 'Dashboard')
        ...
        <div class="">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h2>
                                    <strong><i class="zmdi zmdi-chart"></i> Sales</strong> Report <?php echo date("Y"); ?>
                                </h2>
                                <ul class="header-dropdown">
                                    <li class="dropdown">
                                        ...
                                        <a role="button" class="boxs-close"><i class="zmdi zmdi-close"></i></a> </li>
                                </ul>
                            </div>
                            <div class="form-row">
                                <div class="col-md-3">
                                    <div class="body mb-3 shadow">
                                        <div class="state_w1 mb-1 mt-1">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <i class="zmdi zmdi-balance text-warning animated infinite pulse" style="font-size:4rem;"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="body mb-3 shadow">
                                        <div class="state_w1 mb-1 mt-1">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <i class="zmdi zmdi-turning-sign zmdi-hc-flip-horizontal text-warning animated infinite pulse" style="font-size:4rem;"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="body mb-3 shadow">
                                        <div class="state_w1 mb-1 mt-1">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <i class="zmdi zmdi-refresh-sync-alert text-warning animated infinite pulse" style="font-size:4rem;"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="body mb-3 shadow">
                                        <div class="state_w1 mb-1 mt-1">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <i class="zmdi zmdi zmdi-balance-wallet text-warning animated infinite pulse" style="font-size:4rem;"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="body">
                                                    <div id="authorize-current-month-chart-bar" class="c3_chart"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="body">
                                                    <div id="expigate-current-month-chart-bar" class="c3_chart"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="body">
                                        <div id="week-chart-bar" class="c3_chart"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="body">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="card w_data_1">
                                                    <div class="xbody">
                                                        <div class="w_icon pink"><i class="zmdi zmdi-google"></i>
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card w_data_1">
                                                    <div class="xbody">
                                                        <div class="w_icon cyan"><i class="zmdi zmdi-blogger"></i>
                                                        </div>
                                                    ...
                                                    <div class="body mb-2">
                                                        <div class="form-row align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <h6>{{$brand->name}}</h6>
                                                                <div>
                                                                    <i class="zmdi zmdi-money"></i> {{$brand->spending}}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            <div class="header">
                                <h2><strong><i class="zmdi zmdi-balance"></i> Chargeback</strong> Payments</h2>
                                <ul class="header-dropdown">
                                    <li class="dropdown">
                                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                            <i class="zmdi zmdi-more"></i> </a>
                                    ...
                                    @foreach($data['recentPayments'] as $payment)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="badge badge-success rounded-pill">Paid</span></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    <div class="card">
                        <div class="header">
                            <h2><strong><i class="zmdi zmdi-blogger"></i> {{ config('app.home_name') }}</strong> Brands</h2>
                            <ul class="header-dropdown">
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i class="zmdi zmdi-more"></i> </a>
                                ...
                                <table class="table table-striped table-hover theme-color" data-sorting="false">
                                    ...
                                    @foreach($data['brandData'] as $brand)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="text-warning" href="javascript:void(0)">{{$brand->name}}</a>
                                            </td>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong><i class="zmdi zmdi-accounts-outline"></i> {{ config('app.home_name') }}</strong> Teams</h2>
                            <ul class="header-dropdown">
                                <li class="dropdown">
                                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        <i class="zmdi zmdi-more"></i> </a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover theme-color" data-sorting="false">
                                ...
                                @foreach($data['teamData'] as $team)
                                    <tr>
                                        <td><a href="javascript:void(0)" class="text-warning">{{$team->name}}</a>
                                        </td>
