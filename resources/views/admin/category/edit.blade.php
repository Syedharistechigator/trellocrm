                           ...
                           <!--  -->
                            <form action="{{route('category.update',[$category->id])}}" method="PUT">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{$category->name}}" maxlength="10" minlength="3" >
                                </div>
                                <div class="form-group form-float">
                                    <label for="email_address">Publish</label>
                                    <select class="form-control show-tick ms select2" data-placeholder="Select" name='active' >
                                        <option></option>
