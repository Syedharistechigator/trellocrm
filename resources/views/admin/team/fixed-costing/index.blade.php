@extends('admin.layouts.app')@section('cxmTitle', 'Fixed Costing')
@section('content')
    @push('css')
        @include('admin.team.fixed-costing.style')
    @endpush
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        <h2>Fixed Costings</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}"><i class="zmdi zmdi-home"></i> {{ config('app.home_name') }}
                                </a></li> <li class="breadcrumb-item"> Fixed Costings </li>
                            <li class="breadcrumb-item active"><a href="{{route('admin.team.fixed-costing.index')}}"> List</a></li>
                        </ul>
                        <button class="btn btn-primary btn-icon mobile_menu" type="button">
                            <i class="zmdi zmdi-sort-amount-desc"></i></button>
                    </div>
                    <div class="col-lg-5 col-md-6 col-sm-12 text-right">
                        <button class="btn btn-success btn-icon rounded-circle" type="button" data-toggle="modal" id="create-fixed-costing-modal-btn" data-target="#createFixedCostingModal">
                    ...
                    <div class="col-lg-12">
                        <div class="">
                            <div class="table-responsive">
                                <table id="FixedCostingTable" class="table table-striped table-hover xjs-basic-example theme-color">
                                    <thead>
                                    <tr>
                                    ...
                                    <tbody>
                                    @foreach($fixed_costings as $fixed_costing)
                                        <tr id="tr-{{$fixed_costing->id}}">
                                            <td class="align-middle">{{$fixed_costing->id}}</td>
                                            <td class="align-middle">{{optional($fixed_costing->getTeam)->name}}</td>
                                            <td class="align-middle">${{$fixed_costing->amount}}</td>
                                            <td class="align-middle">{{ DateTime::createFromFormat('!m', $fixed_costing->month)->format('F') }}</td>
                                            <td class="align-middle">{{ $fixed_costing->year }}</td>
                                            <td class="align-middle text-nowrap">
                                                <button data-id="{{$fixed_costing->id}}" title="Edit" class="btn btn-warning btn-sm btn-round editFixedCosting" data-toggle="modal" data-target="#editFixedCostingModal">
                                                    <i class="zmdi zmdi-edit"></i></button>
                                                <a title="Delete" data-id="{{$fixed_costing->id}}" data-type="confirm" href="javascript:void(0);" class="btn btn-danger btn-sm btn-round delButton"><i class="zmdi zmdi-delete"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
    ...
    <!-- Create Fixed Costing -->
    <div class="modal fade" id="createFixedCostingModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="title" id="defaultModalLabel">Create A New Fixed Costing</h4>
                </div>
    ...
    <!-- Edit Fixed Costing -->
    <div class="modal fade" id="editFixedCostingModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="title" id="defaultModalLabel">Edit Fixed Costing</h4>
                </div>
...
@endsection
@push('cxmScripts')
    @include('admin.team.fixed-costing.script')
@endpush
