                        ...
                        <thead>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle"><a class="text-warning" href="#">{{$client->name}}</a></td>
                                        ...
                                        <td class="align-middle"><span class="zmdi zmdi-calendar text-warning"></span> {{$client->created_at->format('j F, Y')}}</td> 
