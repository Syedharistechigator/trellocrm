  ...
  $.chatCtrl = function(element, chat, direction = 'top') {
    ...
    if(chat.position == 'chat-right'){
        ...
        if(!! chat.media_files){
            $.each(chat.media_files, function (key, val) {
              if(val['file_extension'] == '.jpg' || val['file_extension'] == '.png' || val['file_extension'] == '.jpeg'){
                media_files += '<span class="chat-image-view"><a href="'+base_url+'assets/chats/'+val['file_name']+'" download="'+val['original_file_name']+'" class="download-btn-styling delete-msg fas fa-download"></a><img width="150px" src="'+base_url+'assets/chats/'+val['file_name']+'" draggable="false"></span>';
              }else{
      ...
      if(!! chat.media_files){
          $.each(chat.media_files, function (key, val) {
            if(val['file_extension'] == '.jpg' || val['file_extension'] == '.png'  || val['file_extension'] == '.jpeg'){
              media_files += '<span class="chat-image-view"><a href="'+base_url+'assets/chats/'+val['file_name']+'" download="'+val['original_file_name']+'" class="download-btn-styling download-msg fas fa-download"></a><img width="150px" src="'+base_url+'assets/chats/'+val['file_name']+'" draggable="false"></span>';
            }else{
