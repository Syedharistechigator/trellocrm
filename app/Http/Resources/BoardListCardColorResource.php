...
class BoardListCardColorResource extends JsonResource
{
    protected array $relations = [];

    protected array $relation_count = [];

    protected string $source = 'Board List Card Color';
     ...
     * @return $this
     */
    public function additional(array $data): BoardListCardColorResource
    {
