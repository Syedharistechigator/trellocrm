...
//            ->where('cc_infos.card_name', $request->card_name)
    ...
    private function payment_gateway($invoice, $request)
    {
        ...
        if ($invoice->team_key == 254898 || $invoice->team_key == 935383  || $invoice->team_key ==  740441) {
            ...
            if ($payment_complete === 0 && isset($invoice->getBrand)
                ...
                if ($invoice->total_amount > 0 && $invoice->total_amount <= 3999) {
                    if (PaymentMethod::isCapacityAvailable($authorize_id, $invoice->total_amount)) {
                        $card_available = $this->card_available($card_number_enc, $cvv_enc, $request, 8, 'authorize');
                        // if ($card_available) {
            ...
            /** ========================================================================================================================================================================== */
            /** =====================================================> The Creative Labz End <=========================================================================================== */
            /** ========================================================================================================================================================================== */


            /** ================================================================================================================================================================================== */
            /** ==================================================> Creative Solution Agency      <======================================================================================= */
            /** ================================================================================================================================================================================== */
            ...
            if ($payment_complete === 0 && isset($invoice->getBrand) && $invoice->getBrand->is_amazon == 1 && $invoice->getBrand->merchant_id == 2) {
                if ($IS_AMAZON == false) {
...
//                        if (PaymentMethod::isCapacityAvailable($authorize_id, $invoice->total_amount)) {
//                            $card_available = $this->card_available($card_number_enc, $cvv_enc, $request, 7, 'authorize');
//                            if ($card_available) {
//                                $api_url = route('api.authorize.payment');
//                                $inputs['payment_gateway'] = 'authorize';
//                                $inputs['merchant_id'] = $authorize_id;
...
//                /** => Techno Boxer LLC Payment Method End <= */
                ...
                //     if ($invoice->total_amount > 0 && $invoice->total_amount <= 1999) {
                //         if (PaymentMethod::isCapacityAvailable($authorize_id, $invoice->total_amount)) {
                //             $card_available = $this->card_available($card_number_enc, $cvv_enc, $request, 4, 'authorize');
                //             if ($card_available) {
                //                 $api_url = route('api.authorize.payment');
                //                 $inputs['payment_gateway'] = 'authorize';
                //                 $inputs['merchant_id'] = $authorize_id;
...
//                        if ($invoice->total_amount > 0 && $invoice->total_amount <= 3999) {
//                            if (PaymentMethod::isCapacityAvailable($authorize_id, $invoice->total_amount)) {
//                                $card_available = $this->card_available($card_number_enc, $cvv_enc, $request, 9, 'authorize');
//                                if ($card_available) {
//                                    $api_url = route('api.authorize.payment');
//                                    $inputs['payment_gateway'] = 'authorize';
//                                    $inputs['merchant_id'] = $authorize_id;
...
//                        }
//                    } else {
//                        $payment_process_from['authorize'][$authorize_name] = ['error' => 'the CREATIVE is temp disabled'];
//                    }
//                } else {
