...
//            ->where('cc_infos.card_name', $request->card_name)
    ...
    private function payment_gateway($invoice, $request)
    {
        ...
        /** ================================================================================================================================================================================== */
        /** ===================================> KDP (beyonbancard)= 7 on Expigate Payment Method Start <====================================================================== */
        /** ================================================================================================================================================================================== */
        /** => If payment not available on this card within 30 days and amount is less than 2000,  <= */
        ...
        //                 }
        //             }
        //             $payment_process_from['expigate']['KDP_E7'] = ['errors' => $formattedErrors];
        //         } else {
        //             $expigate_id = 7;
        //             if ($VISA_CARD) {
        //                 if ($invoice->total_amount == 1) {
        ...
        //                             $response = Http::withHeaders(['X-Source' => $request->url()])->post($api_url, $inputs);
        //                             $IS_AMAZON = true;
        //                             $ERROR_MSG .= 'KDP E7 Activated.';
        //                             if ($response->json() != null) {
        //                                 if ($response->json()['response'] && $response->json()['response']['response_code'] != '100') {
        //                                     $payment_process_from['expigate']['KDP_E7'] = [$response->json()];
        //                                     if (isset($response->json()['response']['responsetext'])) {
        //                                         $amazon_responsetext = Str::contains($response->json()['response']['responsetext'], 'REFID') ? trim(Str::before($response->json()['response']['responsetext'], 'REFID:')) : $response->json()['response']['responsetext'];
        //                                         $errorMatches = array_intersect([$amazon_responsetext], $ERROR_LIST);
        //                                         if (!empty($errorMatches)) {
        //                                             $IS_ERROR = true;
        //                                             $ERROR = 'Expigate - ' . reset($errorMatches);
        //                                         }
        //                                     } else {
        //                                         $payment_process_from['expigate']['KDP_E7'] = ['error' => 'response text not found in amazon response.'];
        //                                     }
        //                                 } elseif ($response->failed() && $response->json()['response'] && $response->json()['response']['response_code'] != '100') {
        //                                     $failed_response = json_decode($this->failed_request($response->json(), 500, 'expigate')->getcontent(), true);
        //                                     $payment_process_from['expigate']['KDP_E7'] = [$failed_response['errors']];
        //                                     if (isset($response->json()['response']['responsetext'])) {
        //                                         $amazon_responsetext = Str::contains($response->json()['response']['responsetext'], 'REFID') ? trim(Str::before($response->json()['response']['responsetext'], 'REFID:')) : $failed_response['errors'];
        //                                         $errorMatches = array_intersect([$amazon_responsetext], $ERROR_LIST);
        //                                         if (!empty($errorMatches)) {
        ...
        //                                         }
        //                                     } else {
        //                                         $payment_process_from['expigate']['KDP_E7'] = ['error' => 'response text not found in expigate response.'];
        //                                     }
        //                                 } elseif ($response->json()['response'] && $response->json()['response']['response_code'] == '100') {
        //                                     $payment_complete = 1;
        //                                     $payment_process_from['expigate']['KDP_E7'] = [$response->json()];
        ...
        //                             }
        //                         } else {
        //                             $payment_process_from['expigate']['KDP_E7'] = ['error' => 'Status off / Capacity issue. ' . $expigate_id];
        //                         }
        //                     // } else {
        //                     //     $payment_process_from['expigate']['KDP_E7'] = ['error' => 'Card already exists. ' . $expigate_id];
        //                     // }
        //                 } else {
        //                     $payment_process_from['expigate']['KDP_E7'] = ['error' => 'Amount limit' . $expigate_id];
        //                 }
        //             } else {
        //                 $payment_process_from['expigate']['KDP_E7'] = ['error' => 'Not a visa card.'];
        //             }
        //         }
        //     } else {
        //         $payment_process_from['expigate']['KDP_E7'] = ['error' => $ERROR_MSG];
        //     }
        // }
        /** ================================================================================================================================================================================== */
        /** ===================================> KDP (beyonbancard)= 7 on Expigate Payment Method Start <====================================================================== */
        ...
        /** ================================================================================================================================================================================== */
        /** ===================================> THE CREATIVE LABZ... ( )= 6 on Expigate Payment Method Start <====================================================================== */
        /** ================================================================================================================================================================================== */
        /** => If payment not available on this card within 30 days and amount is less than 2000,  <= */
        if ($payment_complete === 0 && isset($invoice->getBrand)
            // && $invoice->getBrand->merchant_id == 2
            ...
            if ($IS_AMAZON == false) {
                ...
                if ($expigate_validator->fails()) {
                    ...
                    $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = ['errors' => $formattedErrors];
                } else {
                    $expigate_id = 6;
                    if ($VISA_CARD) {
                        if ($invoice->total_amount == 0) {
                            ...
                            // if ($card_available) {
                                if (PaymentMethodExpigate::isCapacityAvailable($expigate_id, $invoice->total_amount)) {
                                    ...
                                    $response = Http::withHeaders(['X-Source' => $request->url()])->post($api_url, $inputs);
                                    $IS_AMAZON = true;
                                    $ERROR_MSG .= 'THE CREATIVE LABZ E6 Activated.';
                                    if ($response->json() != null) {
                                        if ($response->json()['response'] && $response->json()['response']['response_code'] != '100') {
                                            $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = [$response->json()];
                                            if (isset($response->json()['response']['responsetext'])) {
                                                $amazon_responsetext = Str::contains($response->json()['response']['responsetext'], 'REFID') ? trim(Str::before($response->json()['response']['responsetext'], 'REFID:')) : $response->json()['response']['responsetext'];
                                                $errorMatches = array_intersect([$amazon_responsetext], $ERROR_LIST);
                                                if (!empty($errorMatches)) {
                                                ...
                                                $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = ['error' => 'response text not found in amazon response.'];
                                            }
                                        } elseif ($response->failed() && $response->json()['response'] && $response->json()['response']['response_code'] != '100') {
                                            $failed_response = json_decode($this->failed_request($response->json(), 500, 'expigate')->getcontent(), true);
                                            $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = [$failed_response['errors']];
                                            if (isset($response->json()['response']['responsetext'])) {
                                                $amazon_responsetext = Str::contains($response->json()['response']['responsetext'], 'REFID') ? trim(Str::before($response->json()['response']['responsetext'], 'REFID:')) : $failed_response['errors'];
                                                $errorMatches = array_intersect([$amazon_responsetext], $ERROR_LIST);
                                                if (!empty($errorMatches)) {
                                                ...
                                                $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = ['error' => 'response text not found in expigate response.'];
                                            }
                                        } elseif ($response->json()['response'] && $response->json()['response']['response_code'] == '100') {
                                            $payment_complete = 1;
                                            $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = [$response->json()];
                                    ...
                                    $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = ['error' => 'Status off / Capacity issue. ' . $expigate_id];
                                }
                            // } else {
                            //     $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = ['error' => 'Card already exists. ' . $expigate_id];
                            // }
                        } else {
                            $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = ['error' => 'Amount limit' . $expigate_id];
                        }
                    } else {
                        $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = ['error' => 'Not a visa card.'];
                    }
                }
            } else {
                $payment_process_from['expigate']['THE_CREATIVE_LABZ_E6'] = ['error' => $ERROR_MSG];
            }
        }
        /** ================================================================================================================================================================================== */
        /** ===================================> THE CREATIVE LABZ... ( )= 6 on Expigate Payment Method Start <====================================================================== */
        ...
        if ($payment_complete === 0 && isset($invoice->getBrand) && $invoice->getBrand->is_amazon == 1
            ...
            if ($IS_AMAZON == false) {
                ...
                if ($expigate_validator->fails()) {
                    ...
                    $amazon_id = 4;
                    if ($VISA_CARD) {
                        if ($invoice->total_amount > 0 && $invoice->total_amount <= 1500) {
                            $card_available = $this->card_available($card_number_enc, $cvv_enc, $request, $amazon_id);
                            if ($card_available) {
                                if (PaymentMethodExpigate::isCapacityAvailable($amazon_id, $invoice->total_amount)) {
                                    $api_url = route('api.expigate.payment');
        ...
        /** ================================================================================================================================================================================== */
        /** ===================================> KDP = 7 on Expigate Payment Method Start <====================================================================== */
        /** ================================================================================================================================================================================== */
        /** => If payment not available on this card within 30 days and amount is less than 3000, payment should be on Amazon <= */
        if ($payment_complete === 0 && isset($invoice->getBrand) && $invoice->getBrand->is_amazon == 1
            // && $invoice->getBrand->merchant_id == 2
        ...
        /** ================================================================================================================================================================================== */
        /** ===================================> KDP  = 7 on Expigate Payment Method End <======================================================================= */
        /** ================================================================================================================================================================================== */
        ...
        /** ================================================================================================================================================================================== */
        /** ===================================> KDP = 6 on Expigate Paycom Method Start <====================================================================== */
        /** ================================================================================================================================================================================== */
        /** => If payment not available on this card within 30 days and amount is less than 3000, payment should be on Amazon <= */
        if ($payment_complete === 0 && isset($invoice->getBrand) 
            // && $invoice->getBrand->merchant_id == 2
        ...
        /** ================================================================================================================================================================================== */
        /** ===================================> KDP  = 6 on Expigate Paycom Method End <======================================================================= */
        /** ================================================================================================================================================================================== */
        ...
        if (!$IS_AMAZON && $payment_complete === 0 && isset($invoice->getBrand)) {
            ...
            if ($invoice->total_amount > 0 && $invoice->total_amount <= 2000 && $invoice->team_key != 139290) {
            ...
            if ($IS_AMAZON == false) {
                if (isset($invoice->getBrand)
                    ...
                    if ($invoice->total_amount > 0 && $invoice->total_amount <= 4000) {
                        if (PaymentMethod::isCapacityAvailable($authorize_id, $invoice->total_amount)) {
                            $card_available = $this->card_available($card_number_enc, $cvv_enc, $request, $authorize_id, 'a uthorize');
                            if ($card_available) {
                                $api_url = route('api.authorize.payment');
                                $inputs['payment_gateway'] = 'authorize';
                                $inputs['merchant_id'] = $authorize_id;
        ...
        //                 // } 
        //                 // else {
        //                 //     $payment_process_from['authorize'][$authorize_name] = ['error' => 'Card already exits.' . $authorize_id];
        //                 // }
        //             // } else {
        //             //     $payment_process_from['authorize'][$authorize_name] = ['error' => 'Status off / Capacity issue new_' . $authorize_id];
        //             // }
        //         } else {
        //             $payment_process_from['authorize'][$authorize_name] = ['error' => 'Amount limit ' . $authorize_id];
        //         }
        ...
        /** ============================================================================================================================================================================== */
        /** =====================================================> Design Curvature 12 Authorization Start <====================================================================================== */
        /** ============================================================================================================================================================================== */
        // if ($payment_complete === 0) {
        //     $authorize_name = str_replace(' ', '_', 'Design Curvature 1');
        //     if ($IS_AMAZON == false) {
        ...
        //                     $card_available = $this->card_available($card_number_enc, $cvv_enc, $request, $authorize_id, 'authorize');
        //                     if (!$card_available) {
        //                         if (PaymentMethod::isAuthorizeAvailable($authorize_id)) {
        //                             $api_url = route('api.authorize.payment.authorization');
        //                             $inputs['payment_gateway'] = 'authorize';
        //                             $inputs['merchant_id'] = 12;
        //                             $payment_gateway = 1;
        //                             $IS_AMAZON = true;
        ...
        //                             }
        //                         } else {
        //                             $payment_process_from['authorize'][$authorize_name] = ['error' => 'Authorization not available. ' . $authorize_id];
        //                         }
        //                     } else {
        //                         $payment_process_from['authorize'][$authorize_name] = ['error' => 'Card available. ' . $authorize_id];
        //                     }
        //                 } else {
        //                     $payment_process_from['authorize'][$authorize_name] = ['error' => 'Status off / Capacity issue. ' . $authorize_id];
        //                 }
        ...
        // }
        /** ============================================================================================================================================================================== */
        /** =====================================================> Design Curvature 12 Authorization End <======================================================================================== */
        /** ============================================================================================================================================================================== */
        /** ****************************************************************************************************************************************************************************** */
            ...
            if ($payment_complete === 0) {
                ...
                if ($IS_AMAZON == false) {
                    ...
                    // } else {
                    //     $payment_process_from['authorize'][$authorize_name] = ['error' => 'Design is temp disabled'];
                    // }
                } else {
                    $payment_process_from['authorize'][$authorize_name] = ['error' => $ERROR_MSG ?? "Amazon condition"];
                }
        ...
        /** ========================================================================================================================================================================== */
        /** =====================================================> Techno Boxer LLC Authorization Start <=========================================================================================== */
        /** ========================================================================================================================================================================== */
        /** => Techno Boxer LLC Payment Method start <= */
        // if ($payment_complete === 0 ) {
        //     $authorize_name = str_replace(' ', '_', 'Techno Boxer LLC');
        ...
        /** => Techno Boxer LLC Payment Method End <= */
        /** ========================================================================================================================================================================== */
        /** =====================================================> Techno Boxer LLC Authorization End <============================================================================================= */
        /** ========================================================================================================================================================================== */
        /** ************************************************************************************************************************************************************************** */
        ...
        /** ****************************************************************************************************************************************************************************** */
        /** ============================================================================================================================================================================== */
        /** =====================================================> THE CREATIVE LABZ [9] Authorization  Start <========================================================================================= */
        /** ============================================================================================================================================================================== */
        // if ($payment_complete === 0) {
        //     $authorize_name = str_replace(' ', '_', 'THE CREATIVE LABZ 9');
        //     if ($IS_AMAZON == false) {
        ...
        // }
        /** ============================================================================================================================================================================== */
        /** =====================================================> THE CREATIVE LABZ[9] Authorization End <============================================================================================= */
        /** ============================================================================================================================================================================== */
        /** ****************************************************************************************************************************************************************************** */
        ...
        if ($payment_complete === 0 && isset($invoice->getBrand)
            ...
            if ($IS_AMAZON == false) {
                ...
                $payment_process_from['amazon']['creative_labz'] = ['error' => $ERROR_MSG ?? "Amazon condition"];
            }
        }
        /** ================================================================================================================================================================================== */
...
//                }
            ...
            $payment_process_from['authorize'][str_replace(' ', '_', 'Authorize Merchants')] = ['error' => $ERROR_MSG ?? "Amazon condition"];
        }
        /** ============================================================================================================================================================================== */
        /** =====================================================> Get Writing Service End <============================================================================================== */
        /** =========================================================> Fresh Only <======================================================================================================= */
...
//             }
//         } else {
//             $payment_process_from['authorize'][str_replace(' ', '_', 'Creative  AGENCY')] = ['error' => 'last else payment completed.'];
//         }
        /** ============================================================================================================================================================================== */
